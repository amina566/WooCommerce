...
class ProductPage:
    ...
    def payarc_checkout(self):
        self.driver.find_element(*ProductLocators.PAYARC_PAYMENT_METHOD).click()
        time.sleep(6)
